...
| Samet DÖNMEZ | Scrum Master | Toplantıya katılamadı; Slack grubuna "evdeki malzemeler + bütçe + israf azaltma" temalı mutfak planlayıcı fikrini (şu anki proje) sundu; fikir kabul edildi. |
...
| Burak BAŞODA | Team Member/Developer | Toplantıya katıldı, sunulan fikirleri değerlendirdi. |
...
| İsim | Rol | Katkı |
|---|---|---|
| Ceren KARABAĞ | Team Member/Developer | Jira board ve GitHub organization + repo kurulumu, README dokümantasyonu. |
...
| Samet DÖNMEZ | Scrum Master | Next.js + shadcn/ui (Base UI) proje kurulumu; ChatGPT tarzı Türkçe sohbet prototipi; aydınlık/karanlık tema; mock veriyle 5 günlük plan, alışveriş listesi ve skorlar; Recharts grafiği; sohbet temizleme akışı; erişilebilirlik; README ve Sprint 1 dokümantasyonu |
...
| Burak BAŞODA | Team Member/Developer | Demo senaryosu ve sunum akışı üzerine görüşler. |
